	...
	$('#dg').datagrid({
	    ...
	    columns:[[    
	    		{field:'id',title:'ID',width:100,hidden:true},
                 {field:'catory',title:'分类',width:200},
                {field:'interfaceName',title:'名称',width:200},
                {field:'interfaceArgs',title:'参数',width:200},
                {field:'interfaceResult',title:'返回值',width:200},
